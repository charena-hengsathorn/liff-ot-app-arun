...
export interface ApiAttendanceAttendance extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Track driver attendance and OT records';
  ...
  attributes: {
    ...
    clockIn: Schema.Attribute.Time;
    clockOut: Schema.Attribute.Time;
    ...
    > &
      Schema.Attribute.Private;
    otEnd: Schema.Attribute.Time;
    otHours: Schema.Attribute.Decimal;
    otStart: Schema.Attribute.Time;
    publishedAt: Schema.Attribute.DateTime;
    submittedAt: Schema.Attribute.DateTime;
    thaiDate: Schema.Attribute.Date & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLoginLogin extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Track login attempts, sessions, and authentication history';
  ...
  attributes: {
    ...
    loginAttemptAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    loginStatus: Schema.Attribute.Enumeration<
